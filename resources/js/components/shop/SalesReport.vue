<template>
  <v-container>
    <v-row class="no-print">
      ...
      <v-row class="pl-2">
        <salesReportFilterModal v-on:onDetailSearch="onDetailSearch" />
        <v-btn class="mt-6" small outlined @click="clearForm">Clear</v-btn>
        <v-btn
          class="mt-6 mx-1"
          small
          text
...
import salesReportFilterModal from "./salesReportFilterModal";

export default {
  components: {
    salesReportFilterModal,
  },
  data: () => ({
    valid: false,
    delete_dialog: false,
